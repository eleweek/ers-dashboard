...
function register_pressreleases_cat_taxonomy() {
	...
	register_taxonomy( 'pressreleases-category', array( 'pressreleases' ), $args );

}
add_action( 'init', 'register_pressreleases_cat_taxonomy', 0 );
