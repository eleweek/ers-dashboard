...
function register_candidates_cat_taxonomy() {
	...
	register_taxonomy( 'candidates-category', array( 'candidates' ), $args );

}
add_action( 'init', 'register_candidates_cat_taxonomy', 0 );
