...
<input type="hidden" name="recurring[interval_length]" value="1">
<input type="hidden" name="recurring[interval_unit]" value="month">
...
<div class="donation-process__step-two">
	...
	<button class="btn donation-process__btn-submit" type="submit">Enter your bank details</button>
