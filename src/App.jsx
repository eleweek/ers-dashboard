...
function HexMaps({ data, unfilteredData, selectedRegion }) {
  ...
  return (
    <div>
      <div className="hexmap-btn-group">
        <div className="btn-group" role="group" aria-label="Basic example">
          <button
            type="button"
            className={classNames(
              "btn",
              tab === "decisive" ? "active" : "btn-outline-primary"
            )}
          ...
          <button
            ...
            className={classNames(
              "btn",
              tab === "surplus" ? "active" : "btn-outline-primary"
            )}
          ...
          <button
            ...
            className={classNames(
              "btn",
              tab === "wasted" ? "active" : "btn-outline-primary"
            )}
...
const FlourishAmsHorseshoeEmbed = () => {
  useEffect(() => {
  ...
  return (
    <div
      ...
      data-src="visualisation/18633267"
    />
  );
};
